...
let restaurant1 = {
  ...
  */
  ...
  let restaurantFinderApplication = {
    ...
    return restaurants.map(x1=>x1.totalSeats-x1.numberOfCustomers>(numberOfPeople))
        
       
     
    },
    findRestaurantServingDish: function (dishName) {
      return restaurants.map(x=> x.menu.includes(dishName))
      
    },
    countNumberOfRestaurantsInArea: function (area1) {
      let area2= restaurants.filter(x3=>x3.address)
      return area2.map(x4=>x4.address.area==area1)
